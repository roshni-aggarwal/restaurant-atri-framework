...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "logo": {
      "custom": {
        "alt": "logo",
        "src": "/app-assets/restaurant-logo.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image12": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/003-cuba-libre.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image18": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/001-location.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image19": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/003-telephone.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image23": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/frenchfries.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image24": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/pancakeszs.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
